...
class PdoGsb {
    ...
    public function getInfosVisiteur($id) {
        $req = "select utilisateur.login as login, utilisateur.nom as nom, utilisateur.prenom as prenom, utilisateur.role as role from utilisateur 
    ...
    public function estUnVisiteurRole($login, $mdp, $role) {
        $req = "select utilisateur.id as id, utilisateur.nom as nom, utilisateur.prenom as prenom, utilisateur.login as login from utilisateur 
    ...
    /*
     * Retourne le nom et le prénom de l'utilisateur ayant l'id passé en paramètre
     */
    ...
    /**
     * Modifie le champ libelle en rajoutant "REFUSE : " devant la chaîne
     * de caractère existante
     * @param type $libelle
     */
    public function updateLibelleFiche($libelle) {
        $req = "update lignefraishorsforfait set libelle = 'REFUSE :' . '$libelle'";
        PdoGsb::$monPdo->exec($req);
    }
    ...
    public function miseEnPaiement($idUtilisateur, $mois) {
        $req = "update ficheFrais set idEtat = 'MP', dateModif = now() 
